    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="rounded-md w-full h-full p-1">
          <div
            className="relative rounded-md  mt-1 w-full space-y-2"
            style={{
            ...
            <div className="pt-24 p-8 absolute rounded-md z-40">
              <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                ...
                <div className="w-full md:w-3/5 py-6 text-center">
                  ...
                  <Image
                    src="/images/hero1-black.svg"
                    alt="Hero Black Illustration"
                    width={800} // ← sesuaikan ukuran aslinya
                    height={450}
                    className="w-[250px] h-[250px] md:h-[450px] md:w-4/5 z-50 mx-auto"
                  />
                </div>
              </div>
            </div>
            <div
              className="rounded-md absolut z-2"
