...
export default function Page() {
    ...
    const fetchPageData = async (departmentName: string, pageNumber: number, rowPerPage: number) => {
        const response = await GetDepartmentsPage(departmentName, pageNumber, rowPerPage);
                ...
                <div className="rounded-md w-full h-full p-4">
                    <div className="flex items-center py-4">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-2 sm:space-y-0">
                            ...
                            <FormDepartment title="Add Department" id={0} onSuccess={() => fetchPageData(searchDepartmentName, page, row)} />
                        </div>
                    </div>
                    <DataTable columns={columns(fetchPageData, searchDepartmentName, page, row)} data={data} />
